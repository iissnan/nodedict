...
module.exports.apiCount = function () {
    ...
    var apiCount = {
        init: function (){
            var countFile = __dirname + "/../data/api.count.json";
            var apiCount = {};
            this.data = {};
            if (fs.existsSync(countFile)) {
                apiCount = fs.readFileSync(countFile);
                try {
        ...
        save: function (){
            fs.writeFileSync(__dirname + "/../data/api.count.json", JSON.stringify(this.data), "utf-8");
        }
    };
